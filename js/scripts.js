...
async function fetchTokensInvested() {
    ...
    const res = await fetch(`https://api.ethplorer.io/getAddressTransactions/0x34B365C3a98D0ec12A680047FE299aff2a032554?apiKey=EK-htz4u-dfTvjqu-7YmJq&limit=1000`, options);
